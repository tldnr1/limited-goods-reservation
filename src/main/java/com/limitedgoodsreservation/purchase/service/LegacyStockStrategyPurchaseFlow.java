...
@Service
public class LegacyStockStrategyPurchaseFlow implements PurchaseFlow {

    public static final String ARCHITECTURE_NAME = "legacy-stock-strategy";
    ...
    public LegacyStockStrategyPurchaseFlow(
    ...
    public String metricsName() {
        return stockDeductionStrategyResolver.selectedStrategyName();
    }
